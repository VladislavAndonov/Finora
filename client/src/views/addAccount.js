  ...
  return html`
    <div class="add-account">
      <header class="add-account__header">
        <button class="add-account__back" @click=${() => history.back()} type="button"><i class="fa-solid fa-arrow-left"></i></button>
      ...
      <div class="add-account__content">
        <form @submit=${onSubmit} id="add-account-form">
          ...
          <input
            class="account-form__currency-hidden"
            type="text"
            name="currency"
          ...
          <input
            class="account-form__name-input"
            type="text"
            name="name"
            id="name"
          ...
          <!-- Starting balance -->
          <div class="starting-balance-row">
            <label for="startingBalance">Starting at</label>
            <input
              class="account-form__balance-input"
              type="number"
              name="startingBalance"
              id="startingBalance"
              placeholder="${currencySign}0"
              step="0.1"
            />
          </div>
    ...
    (c) => html`
                <button
                  type="button"
                  class="currency-btn ${selectedCurrency === c.code ? "selected" : ""}"
